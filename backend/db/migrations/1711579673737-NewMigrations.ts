...
export class NewMigrations1711579673737 implements MigrationInterface {
    name = 'NewMigrations1711579673737'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "collections" ADD CONSTRAINT "FK_f9aa46fff6f68d76a71d65df6d5" FOREIGN KEY ("userIdId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "collection_items" ADD CONSTRAINT "FK_32e76b676e06b5bb24c68194a78" FOREIGN KEY ("collectionIdId") REFERENCES "collections"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "collection_item_tags" ADD CONSTRAINT "FK_453a5baf00ac509141644991e3d" FOREIGN KEY ("tagIdId") REFERENCES "tags"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_67efeade3b8abda682d394279a2" FOREIGN KEY ("itemIdId") REFERENCES "collection_items"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "likes" ADD CONSTRAINT "FK_1735b43a2674692e5620c78d02c" FOREIGN KEY ("itemIdId") REFERENCES "collection_items"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "custom_fields" ADD CONSTRAINT "FK_e71a092bfa62ff9d369abff3b1c" FOREIGN KEY ("collectionIdId") REFERENCES "collections"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "collection_item_custom_fields" ADD CONSTRAINT "FK_c7a39112cb44006a26a887374c5" FOREIGN KEY ("collectionItemIdId") REFERENCES "collection_items"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "collection_item_custom_fields" ADD CONSTRAINT "FK_f56ea84aac5c67035f84d4459d8" FOREIGN KEY ("customFieldIdId") REFERENCES "custom_fields"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
